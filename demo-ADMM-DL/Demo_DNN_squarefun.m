%%%% On realizing square function via ADMM, please cite the following paper:
...
d = 1; % input dimension
xtr = -1+2*rand(ntr,d).'; % input lying in [-1,1]
ytr = sum(xtr.^2,1); % output y=\|x\|^2
...
for i=2:L+1
    dim(i) =100; % the number of hidden neurons 
end
clear i;
